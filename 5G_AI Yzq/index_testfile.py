...
if __name__ == '__main__':
    ...
    # spell_log(df_train_syslog, df_type='sys_train', sysmonitor=True)   #做生成经过日志模板提取， 参数提取之后的df_log
    #
